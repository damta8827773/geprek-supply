...
INSERT INTO "new_Supplier" ("createdAt", "icon", "id", "inStock", "lat", "lng", "material", "name", "price", "regionId", "unit", "updatedAt") SELECT "createdAt", "icon", "id", "inStock", "lat", "lng", "material", "name", "price", "regionId", "unit", "updatedAt" FROM "Supplier";
DROP TABLE "Supplier";
